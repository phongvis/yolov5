...
def download(gs_data_dir, train_folder, unittest_folder, handmade_folder):
    ...
    download_bucket(gs_data_dir, handmade_folder)
...
if __name__ == '__main__':
    ...
    download(config['storage']['gs_data_dir'], opt.train_folder, opt.unittest_folder, config['handmade_test']['dir'])